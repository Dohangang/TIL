...
//   for (let i = 0; i < topping.length - 1; i++) {
//     let leftSide = new Set(topping.slice(0, i + 1));
//     let rightSide = new Set(topping.slice(i + 1));
